...
from ERAVIBES.utils.inline import alive_panel, music_start_panel, start_pannel
...
"""
        ...
        try:
            ...
            era = await message.reply_text(f"**ᴅιиg ᴅσиg ꨄ︎❣️.....**")
            await era.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎.❣️....**")
            await era.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎..❣️...**")
            await era.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎...❣️..**")
            await era.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎....❣️.**")
            await era.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎.....❣️**")
            ...
            await era.delete()
            eras = await message.reply_text("**⚡ѕ**")
            await asyncio.sleep(0.1)
            await eras.edit_text("**⚡ѕт**")
            # await asyncio.sleep(0.1)
            await eras.edit_text("**⚡ѕтα**")
            #  await asyncio.sleep(0.1)
            await eras.edit_text("**⚡ѕтαя**")
            # await asyncio.sleep(0.1)
            await eras.edit_text("**⚡ѕтαят**")
            # await asyncio.sleep(0.1)
            await eras.edit_text("**⚡ѕтαятι**")
            # await asyncio.sleep(0.1)
            await eras.edit_text("**⚡ѕтαятιи**")
            # await asyncio.sleep(0.1)
            await eras.edit_text("**⚡ѕтαятιиg**")
            # await asyncio.sleep(0.1)
            await eras.edit_text("**⚡ѕтαятιиg.**")
            await asyncio.sleep(0.1)
            await eras.edit_text("**⚡ѕтαятιиg....**")
